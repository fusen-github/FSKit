...
- (void)layoutSubviews
{
    ...
    _activityIndicatorView.center = CGPointMake(SDActivityIndicatorViewMargin, self.bounds.size.height * 0.5);
    _stateIndicatorView.center = _activityIndicatorView.center;
    
    _textIndicator.center = CGPointMake(self.bounds.size.width * 0.5, _activityIndicatorView.bounds.size.height * 0.5 + SDTextIndicatorMargin);
    _timeIndicator.center = CGPointMake(self.bounds.size.width * 0.5, self.bounds.size.height - _timeIndicator.bounds.size.height * 0.5 - SDTimeIndicatorMargin);
}
