...
+ (NSString *)uniqueGlobalDeviceIdentifier //无效
{
    if ([[NSUserDefaults standardUserDefaults ]objectForKey:@"Device_Hardware_imei"]) {
        return [[NSUserDefaults standardUserDefaults ]objectForKey:@"Device_Hardware_imei"];
    }
    
    NSString *macaddress = [[UIDevice currentDevice] macaddress];//无效
    NSLog(@"macaddress-----------%@",macaddress);
    NSString *uniqueIdentifier = [MD5Utils stringFromMD5:macaddress];
    [[NSUserDefaults standardUserDefaults]setObject:uniqueIdentifier forKey:@"Device_Hardware_imei"];
