...
- (void)setImageToBlurCompletionBlock:(LBBlurredImageCompletionBlock)completion {
    if (self.image) {
        [self setImageToBlur:self.image blurRadius:kLBBlurredImageDefaultBlurRadius completionBlock:completion];
    }
}
@end
